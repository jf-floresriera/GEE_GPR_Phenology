...
class GEEPanelDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        ver = QLabel("GEEGPRPheno v1.5.2  —  UNAL Laboratorio 227")
    ...
    def _make_info_tab(self):
        ...
        ver = QLabel("Version 1.5.2  |  QGIS 3.x  |  Python 3.x")
...
class GEEGPRPhenoPlugin:
    ...
    def initGui(self):
        ...
        act_install = QAction(_tr("Instalar/actualizar dependencias Python"), self.iface.mainWindow())
    ...
    def _install_dependencies(self):
        ...
        try:
            ...
            ret = QMessageBox.question(
                self.iface.mainWindow(),
                _tr("Instalar dependencias Python"),
                msg,
                QMessageBox.Yes | QMessageBox.No,
                QMessageBox.No
            )
