...
_TRANSLATIONS = {
    'en': {
        ...
        'Instrucciones para instalar dependencias Python': 'Python dependency installation instructions',
    ...
    'pt': {
        ...
        'Instrucciones para instalar dependencias Python': 'Instruções para instalar dependências Python',
