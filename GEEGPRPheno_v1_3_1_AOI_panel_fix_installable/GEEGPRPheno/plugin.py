...
class GEEPanelDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        ver = QLabel("GEEGPRPheno v1.3.0  —  UNAL Laboratorio 227")
    ...
    def _make_info_tab(self):
        ...
        ver = QLabel("Version 1.3.0  |  QGIS 3.x  |  Python 3.x")
...
class GEEGPRPhenoPlugin:
    ...
    def initGui(self):
        ...
        # Desde v1.3.0 el panel NO se abre automáticamente al iniciar QGIS.
